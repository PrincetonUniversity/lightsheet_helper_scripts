...
if __name__ == '__main__':
	...
	data_dir = os.path.join(home_dir,'data','heatmap_volumes')
	datasets = ['HSV-H129_Disynaptic','HSV-H129_Trisynaptic','PRV_Disynaptic']
	for dataset in datasets:
		print(dataset)
		layer_name = f'{dataset}_heatmap'
		...
		heatmap_vol_file = os.path.join(data_dir,f'{dataset}_heatmap.tif')
		image = tifffile.imread(heatmap_vol_file)
