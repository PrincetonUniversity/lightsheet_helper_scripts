...
#SBATCH -o logs/precomputed_step1_%j.out        # STDOUT
#SBATCH -e logs/precomputed_step1_%j.err        # STDERR
...
xvfb-run -d python make_precomputed_corrected.py step1 ${viz_dir} ${image_resolution} ${channel_name}
