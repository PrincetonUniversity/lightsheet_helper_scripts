...
tif_dir = '/home/ahoag/mounts/LightSheetTransfer/kelly/201908_cfos/190821_m61467_demons_20190702_1d3x_647_008na_1hfds_z5um_250msec_14-09-11/'
# home_dir = '/home/ahoag/ngdemo'
...
def make_info_file(commit=True):
	info = CloudVolume.create_new_info(
		...
		resolution = [ 5000, 5000, 5000 ], # X,Y,Z values in nanometers, 40 microns in each dim. 
		voxel_offset = [ 0, 0, 0 ], # values X,Y,Z values in voxels
		chunk_size = [ 1024, 1024, 1 ], # rechunk of image X,Y,Z in voxels, 
		volume_size = [2160,2560,1271], # X,Y,Z size in voxels
	)

	# If you're using amazon or the local file system, you can replace 'gs' with 's3' or 'file'
	vol = CloudVolume('file:///home/ahoag/ngdemo/demo_bucket/m61467_demons_20190702/190821_647', info=info)
	vol.provenance.description = "Kelly example dataset"
...
def process(z):
	img_name = tif_dir + '/14-09-11_UltraII_raw_RawDataStack[00 x 00]_C00_xyz-Table Z%04d_UltraII Filter0000.ome.tif' % z
