...
tif_dir = '/home/wanglab/mounts/scratch/zmd/20170411_db_bl6_crii_mid_53hr/transformed_annotations/single_tifs'
...
def make_info_file(commit=True):
	...
	vol = CloudVolume('file:///home/wanglab/Documents/neuroglancer/20170411_db_bl6_crii_mid_53hr/atlas', info=info)
...
def process(z):
	img_name = os.path.join(tif_dir, '20170411_db_bl6_crii_mid_53hr_annotation_Z%04d.tif' % z)
...
def make_demo_downsample(mip_start=0,num_mips=3):
	cloudpath = 'file:///home/wanglab/Documents/neuroglancer/20170411_db_bl6_crii_mid_53hr/atlas'
...
#
#	vol = make_info_file()
#	progress_dir = mkdir(home_dir + '/progress_20170411_db_bl6_crii_mid_53hr_atlas/') # unlike os.mkdir doesn't crash on prexisting 
