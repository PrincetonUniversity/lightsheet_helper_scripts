...
#SBATCH -o logs/precomputed_cells_step2_%j.out        # STDOUT
#SBATCH -e logs/precomputed_cells_step2_%j.err        # STDERR
...
xvfb-run -d python make_precomputed_rawcells.py step2 ${viz_dir} ${animal_id}
