...
#SBATCH -n 19                 # number of cores
#SBATCH -t 5                 # time (minutes)
#SBATCH -o logs/precomputed_data_step2_%j.out        # STDOUT
#SBATCH -e logs/precomputed_data_step2_%j.err        # STDERR
...
xvfb-run -d python make_precomputed_rawdata.py step2 ${viz_dir} ${animal_id}
