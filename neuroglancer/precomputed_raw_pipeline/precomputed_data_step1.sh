...
#SBATCH -o logs/precomputed_data_step1_%j.out        # STDOUT
#SBATCH -e logs/precomputed_data_step1_%j.err        # STDERR
...
. activate lightsheet
xvfb-run -d python make_precomputed_rawdata.py step1 ${viz_dir} ${animal_id}
