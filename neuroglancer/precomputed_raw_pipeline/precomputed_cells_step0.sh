...
#SBATCH -o logs/precomputed_cells_step0_%j.out        # STDOUT
#SBATCH -e logs/precomputed_cells_step0_%j.err        # STDERR
...
xvfb-run -d python make_precomputed_rawcells.py step0 ${viz_dir} ${animal_id}
