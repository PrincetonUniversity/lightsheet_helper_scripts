...
#SBATCH -n 17                 # number of cores
#SBATCH -t 4                 # time (minutes)
#SBATCH -o logs/precomputed_cells_step1_%j.out        # STDOUT
#SBATCH -e logs/precomputed_cells_step1_%j.err        # STDERR
...
xvfb-run -d python make_precomputed_rawcells.py step1 ${viz_dir} ${animal_id}
