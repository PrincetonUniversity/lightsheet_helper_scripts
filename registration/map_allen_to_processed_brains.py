...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  8 16:20:47 2019
...
if __name__ == "__main__":
    ...
    outdr = "/jukebox/wang/zahra/h129_contra_vs_ipsi/reg_to_allen_inverse"
    ...
    fx = [xx for xx in volumes if "488" in xx and "ch00" in xx][0]
