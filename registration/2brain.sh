...
#SBATCH -o /scratch/zmd/logs/2brain_%a.out        # STDOUT
#SBATCH -e /scratch/zmd/logs/2brain_%a.err        # STDERR
...
python map_allen_to_processed_brains.py ${SLURM_ARRAY_TASK_ID} 
