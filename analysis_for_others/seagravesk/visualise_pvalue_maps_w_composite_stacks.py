...
if __name__ == "__main__":
    ...
    allen_id_table = "/jukebox/LightSheetTransfer/atlas/ls_id_table_w_voxelcounts_16bit.xlsx"
    dorsal = "/jukebox/wang/seagravesk/lightsheet/cfos_raw_images/pooled_analysis/2019/pvalue_maps/dorsal_up"
    ...
    make_2D_overlay_of_heatmaps(src, atl_pth, ann_pth, allen_id_table, save_dst, "demonstrator_v_control", positive = True, negative = True)
    #observer vs control
    src = os.path.join(dorsal, "observer_v_control/pvalues_observer_v_control.tif")
    save_dst = os.path.dirname(src)
    make_2D_overlay_of_heatmaps(src, atl_pth, ann_pth, allen_id_table, save_dst, "observer_v_control", positive = True, negative = True)
    #demonstrator vs observer
    src = os.path.join(dorsal,"demonstrator_v_observer/pvalues_demonstrator_v_observer.tif")
    save_dst = os.path.dirname(src)
    make_2D_overlay_of_heatmaps(src, atl_pth, ann_pth, allen_id_table, save_dst, "demonstrator_v_observer", positive = True, negative = True)
