...
brain = os.path.join(imgs_pth, "171206_f37077_observer_20171011_790_015na_1hfsds_z5um_1000msec_12-27-06")
...
for zpln in zplns2load:
    ...
    #get all points corresponding to that plane    
    pnts = np.asarray([xx for xx in arr if xx[0] == zpln])
    ...
    for pntn in range(len(pnts)):
        ...
        axes[1].set_xticks(np.arange(0, len(xprofile), 10))
        axes[1].legend()
