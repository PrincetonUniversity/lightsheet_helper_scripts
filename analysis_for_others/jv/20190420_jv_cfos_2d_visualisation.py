# -*- coding: utf-8 -*-
"""
Created on Sat Apr 20 18:28:52 2019
...
#        cmap.set_under("white", alpha = 0)
        ...
        if volume: 
            ...
            tifffile.imsave(os.path.join(self.dst, "{}_points_merged.tif".format(os.path.basename(os.path.dirname(os.path.dirname(self.src))))), merged)
