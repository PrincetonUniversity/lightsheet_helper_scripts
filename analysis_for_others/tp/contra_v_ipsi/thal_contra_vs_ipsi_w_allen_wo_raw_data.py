...
plt.savefig(os.path.join(sv_dst, "density_ratios.pdf"), bbox_inches = "tight")
...
plt.savefig(os.path.join(sv_dst, "count_ratios.pdf"), bbox_inches = "tight")
...
df.to_csv(os.path.join(sv_dst, "ratio_stats.csv"))
