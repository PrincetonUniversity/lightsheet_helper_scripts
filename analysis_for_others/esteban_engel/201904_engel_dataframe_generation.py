...
#for eroded atlas
dst = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update"
...
df.to_csv(os.path.join(dst, "cell_counts_dataframe_75um_erosion_100um_ventricular_erosion.csv"), index = None)
#%%
...
src = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update"
...
#export
df.to_csv(os.path.join(dst, "cell_counts_w_percent_density_erosion.csv"), index = None)
...
#set variables
csv_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/cell_counts_w_percent_density_erosion.csv"
...
tdf.to_csv(os.path.join(src, "cell_counts_progenitors_w_percents_density_erosion.csv"), header = True, index = None)
...
#aggregate counts
df_new = tdf.groupby(["progenitor", "Brain"])["Count", "percent", "voxels_in_structure"].sum()
df_new["density"] = df_new[df_new.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#save as csv 
df_new.to_csv(os.path.join(src, "summed_progenitors_counts_w_percents_density_erosion.csv"), header = True)
...
#save as csv 
tdf.to_csv(os.path.join(src, "cell_counts_parents_w_percents_density_erosion.csv"), header = True, index = None)

print("saved in :{}".format(src))
    
#%%
#aggregate counts
df_new = tdf.groupby(["parent", "Brain"])["Count", "percent", "voxels_in_structure"].sum()
df_new["density"] = df_new[df_new.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#save as csv 
df_new.to_csv(os.path.join(src, "summed_parents_counts_w_percents_density_erosion.csv"), header = True)
...
#save as csv 
tdf.to_csv(os.path.join(src, "cell_counts_children_w_percents_density_erosion.csv"), header = True, index = None)

print("saved in :{}".format(src))    
 
#%%
#aggregate counts
df_new = tdf.groupby(["child", "Brain"])["Count", "percent", "voxels_in_structure"].sum()
df_new["density"] = df_new[df_new.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#save as csv 
df_new.to_csv(os.path.join(src, "summed_children_counts_w_percents_density_erosion.csv"), header = True)
...
df_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/atlas/ARA2_annotation_info_w_voxel_counts.csv"
ann_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/atlas/annotation_25_ccf2015_forDVscans_z_thru_240.tif"
atl_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/atlas/average_template_25_sagittal_forDVscans_z_thru_240.tif"
...
for fl in lst:
    ...
    nm = os.path.basename(fl)
    #make dataframe
    df = pd.read_csv(fl+"/Annotated_counts_old.csv" , error_bad_lines=False, names=["Index", "Count", "struct", "sub", "layer"])
    print(nm, df.shape)
    df = df.replace(np.nan, "", regex=True)
    f1 = df.struct.values
    f2 = df["sub"].values
...
df = pd.concat(bglst)
df["Count"] = df["Count"].apply(int)
df.to_csv(os.path.join(dst, "cell_counts_dataframe.csv"), index = None)
#%%
#make percent counts per brain FOR BOTH COHORTS
csv_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/cell_counts_dataframe.csv"
src = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update"
lut_pth = "/jukebox/wang/zahra/clearmap_cluster_copy/ClearMap/Data/ARA2_annotation_info_w_voxel_counts.csv"
ann_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/atlas/annotation_25_ccf2015_forDVscans.nrrd"
...
#set variables
csv_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/cell_counts_w_percent_density.csv"
...
#save both as csv and pickle for visualisation
tdf.to_csv(os.path.join(src, "cell_counts_progenitors_w_percents_density.csv"), header = True, index = None)
...
df_new["density"] = df_new[df_new.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#save as csv 
df_new.to_csv(os.path.join(src, "summed_progenitors_counts_w_percents_density.csv"), header = True)
...
#save as csv 
tdf.to_csv(os.path.join(src, "cell_counts_parents_w_percents_density.csv"), header = True, index = None)
...
df_new["density"] = df_new[df_new.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#save as csv 
df_new.to_csv(os.path.join(src, "summed_parents_counts_w_percents_density.csv"), header = True)
...
#save as csv 
tdf.to_csv(os.path.join(src, "cell_counts_children_w_percents_density.csv"), header = True, index = None)
...
df_new["density"] = df_new[df_new.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#save as csv 
df_new.to_csv(os.path.join(src, "summed_children_counts_w_percents_density.csv"), header = True)

print("saved in :{}".format(src))
#%%
#concantenate all dfs
df1 = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/summed_children_counts_w_percents_density_erosion.csv"
df2 = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/summed_parents_counts_w_percents_density_erosion.csv"
df3 = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/summed_progenitors_counts_w_percents_density_erosion.csv"
...
df_erosion = pd.concat([df1, df2, df3])

#%%
df4 = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/summed_children_counts_w_percents_density.csv"
df5 = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/summed_parents_counts_w_percents_density.csv"
df6 = "/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/summed_progenitors_counts_w_percents_density.csv"
...
df_no_erosion = pd.concat([df4, df5, df6])
...
df.to_csv("/jukebox/LightSheetData/pni_viral_vector_core/201902_promoter_exp_6mo/analysis/cell_detection/20190506_update/composite_cell_detection_results_6mo_cohort_w_percent_density_erosion.csv", index = None)
...
#%%
#erosion
src = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update"
...
df = pd.concat(bglst)
df["Count"] = df["Count"].apply(int)
df.to_csv(os.path.join(src, "cell_counts_dataframe_75um_erosion_100um_ventricular_erosion.csv"), index = None)

#%%
#make percent counts per brain FOR BOTH COHORTS
csv_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/cell_counts_dataframe_75um_erosion_100um_ventricular_erosion.csv"
src = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update"
lut_pth = "/jukebox/wang/zahra/clearmap_cluster_copy/ClearMap/Data/ARA2_annotation_info_w_voxel_counts.csv"
ann_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/atlas/annotation_25_ccf2015_forDVscans.nrrd"
...
df["density"] = df[df.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#export
df.to_csv(os.path.join(src, "cell_counts_w_percent_density_erosion.csv"), index = None)
...
#set variables
csv_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/cell_counts_w_percent_density_erosion.csv"
...
df = pd.concat(bglst)
df["Count"] = df["Count"].apply(int)
df.to_csv(os.path.join(src, "cell_counts_dataframe.csv"), index = None)
#%%
#make percent counts per brain FOR BOTH COHORTS
csv_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/cell_counts_dataframe.csv"
src = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update"
lut_pth = "/jukebox/wang/zahra/clearmap_cluster_copy/ClearMap/Data/ARA2_annotation_info_w_voxel_counts.csv"
ann_pth = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/atlas/annotation_25_ccf2015_forDVscans.nrrd"
...
df["density"] = df[df.voxels_in_structure > 0].apply(lambda x:x.Count/(float(x.voxels_in_structure*(scale**3))), 1)
#export
df.to_csv(os.path.join(src, "cell_counts_w_percent_density.csv"), index = None)
...
#%%
#concantenate all dfs
df1 = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/summed_children_counts_w_percents_density_erosion.csv"
df2 = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/summed_parents_counts_w_percents_density_erosion.csv"
df3 = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/summed_progenitors_counts_w_percents_density_erosion.csv"
...
#%%
df4 = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/summed_children_counts_w_percents_density.csv"
df5 = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/summed_parents_counts_w_percents_density.csv"
df6 = "/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/summed_progenitors_counts_w_percents_density.csv"
...
df.to_csv("/jukebox/LightSheetData/pni_viral_vector_core/201808_promoter_exp/analysis/cell_detection/20190506_update/composite_cell_detection_results_1mo_cohort_w_percent_density_erosion.csv", index = None)
