...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 12:47:41 2019
...
def make_table_of_transformed_cells(src):
    ...
    try:
        ...
        if points.shape == raw.shape:
            ...
            pd.DataFrame.from_dict(table, orient = "columns").to_csv(os.path.join(src, "Annotated_counts_intensities_w_all_structures.csv"))
            ...
            pd.DataFrame.from_dict(table, orient = "columns").to_csv(os.path.join(src, "Annotated_counts_w_all_structures.csv"))
