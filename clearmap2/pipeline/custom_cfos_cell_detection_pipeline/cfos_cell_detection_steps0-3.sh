...
clearmap_params_file='/jukebox/wang/sanjeev/cm_output/cell_detection_parameter_ss.p'
...
request_name=${request_name},output_rootpath=${output_rootpath} \
...
request_name=${request_name},blocks_per_job=${blocks_per_job},\
...
clearmap_params_file=${clearmap_params_file} \
	...
	OUT4=$(sbatch --parsable --dependency=afterok:${OUT3##* } \
	--export=ALL,sample_dir=${sample_dir},\
request_name=${request_name},output_rootpath=${output_rootpath},atlas=${atlas} \
	spock-clearmap/slurm_scripts/postprocessing.sh)
	echo "Step 4: Register cells to atlas and create brain region count dataframe"
	echo $OUT4
