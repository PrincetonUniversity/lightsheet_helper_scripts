...
if __name__ == '__main__':
    ...
    #ann = "/jukebox/LightSheetTransfer/atlas/allen_atlas/annotation_2017_25um_sagittal_16bit_hierarch_labels_fillmissing.tif" #Allen atlas
    ann = "/jukebox/LightSheetTransfer/atlas/annotation_saggital_atlas_IOannotated_20um_iso_16bit.tif"
    ...
    if step == 'step1': # copy files and run transformix
        ...
        if not os.path.exists(transformed_ann):
            print(ann, aldst, transformfiles[-1])
