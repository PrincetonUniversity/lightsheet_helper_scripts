...
if __name__ == "__main__":
    ...
    dct = {"inputlist": inputlist,
      ...
      "reorientation": ("2","0","1"),
      "crop": "[:,:,:]",
      "dst": "/jukebox/wang/pisano/tracing_output/antero_4x_analysis/linear_modeling/neocortex/injection_sites",
    ...
    atl = fix_orientation(tifffile.imread(dct["atlas"])[:, 423:, :], dct["reorientation"]) #cut at 423 for HSV??
    #make counter
    ...
    plt.savefig(os.path.join("/home/wanglab/Desktop/hsv_nc_inj_heatmap_cb_inverted_reds.pdf"), dpi = 300, transparent = True);
    plt.close()